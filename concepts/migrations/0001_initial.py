    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('studio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='concepts', to='studios.studio')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('studio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='photos', to='studios.studio')),
            ],
            options={
                'abstract': False,
            },
