...
urlpatterns = [
    ...
    #path("concept/<int:concept_pk>/photos/<int:photo_pk>/delete/", concept_view.delete_photo, name="concept_delete-photo",),
    #path("concept/<int:concept_pk>/delete/", concept_view.delete_concept, name="concept_delete-concept",),
